...
def dev_test_train(text_file: str, outpath: str):
    ...
    with open(text_file, "r") as textfile_fh:
        ...
        # 'mn' is your language code, adapt accordingly
        to_tsv(train_lines, f"{outpath}/mn/train/train.tsv")
        to_tsv(dev_lines, f"{outpath}/mn/dev/dev.tsv")
        to_tsv(test_lines, f"{outpath}/mn/test/test.tsv")
