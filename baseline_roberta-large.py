...
run_name= f"{model_checkpoint}-{task}-multi"
...
val_data += load("data/sepp_nlg_2021_train_dev_data.zip","dev","fr")
val_data += load("data/sepp_nlg_2021_train_dev_data.zip","dev","it")
...
train_data += load("data/sepp_nlg_2021_train_dev_data.zip","train","fr")
...
tokenizer = AutoTokenizer.from_pretrained(model_checkpoint, strip_accent=False, add_prefix_space=True)
...
print("tokenize validation data. 1")
