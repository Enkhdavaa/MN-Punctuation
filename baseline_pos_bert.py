...
from transformers import AutoTokenizer, Adafactor, AutoConfig
...
run_name= f"{model_checkpoint}-{task}-pos-sample"
...
model = AutoModelForTokenClassification.from_config(config)#,config = config
#model.num_labels = 2
