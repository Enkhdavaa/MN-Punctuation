...
class PunctuationModel():
    def __init__(self, model = "Enkhdavaa/roberta-base-mongolian_sentence_punctuation") -> None:        
...
if __name__ == "__main__":    
    ...
    text = "Гурван уулын дунд нэгэн жижигхэн тосгон байжээ тэр тосгонд нэгэн ядуу хүү амьдардаг байлаа гэвч бидний нэрийг мэддэггүй бид яах билээ"
